...
function Footer() {
  return (
    <footer className="footer" id="contacts">
      <a className="footer__logo-link" href="#" target="_blank"><img className="footer__logo" src="./images/footer/logo-text.svg" alt="Логотип фестиваля Любимовка" /></a>
        ...
        <ul className="footer__partners-list list">
          <li className="footer__partners-list-item"> 
            <a className="footer__partners-link" href="https://www.prokhorovfund.ru" target="_blank" rel="noopener noreferrer">
              <img className="footer__partners-logo" src="./images/footer/partner-logo/partner-prokhorov.svg" alt="Логотип Фонда Михаила Прохорова" />
            </a>
          ...
          <li className="footer__partners-list-item">
            <a className="footer__partners-link" href="https://mosbrew.ru" target="_blank" rel="noopener noreferrer">
              <img className="footer__partners-logo" src="./images/footer/partner-logo/partner-mosbrew.svg" alt="Логотип Московской пивоваренной компании" />
            </a>
          </li>
          <li className="footer__partners-list-item">
            <a className="footer__partners-link" href="https://sbtg.ru" target="_blank" rel="noopener noreferrer">
              <img className="footer__partners-logo" src="./images/footer/partner-logo/partner-sbtg.svg" alt="Логотип видеокомпании SBTG" />
            </a>
          ...
          <li className="footer__partners-list-item">
            <a className="footer__partners-link" href="https://vk.com/public211134323" target="_blank" rel="noopener noreferrer">
              <img className="footer__partners-logo" src="./images/footer/partner-logo/partner-a-pogovorit.svg" alt="Логотип подкаста А поговорить" />
            </a>
          </li>
        </ul>
      </nav>
      ...
      <div className="footer__credits-design">
        <img className="footer__credits-design-logo" src="./images/footer/icon-developer-studio-logo.svg" alt="Логотип дизайн-студии" />
